...
import { ListCarouselByIdAction, UpdateCarouselByIdAction, UploadCarouselAction } from "../../../redux/action/carousel.action";
...
export const NewCarousel = () => {
  ...
  const SendRequest = async (e: NewCarouselProps) => {
    if (params.id) {
      const data = await dispatch(UpdateCarouselByIdAction({
        data: e,
        id: params.id
      }))
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Box>
                <AppInput
                  ...
                  value={values.dataImage as string} onChange={handleChange('dataImage')} onBlur={handleBlur('dataImage')} />
              </Box>
              <Box>
                <AppInput
                  ...
                  value={values.dataAlt as string} onChange={handleChange('dataAlt')} onBlur={handleBlur('dataAlt')} />
              </Box>
              <Box mt={1}>
